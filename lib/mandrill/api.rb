module Mandrill
  class Templates
    ...
    def add(name, from_email = nil, from_name = nil, subject = nil, code = nil, text = nil, publish = true, labels = [])
      ...
      @master.call "templates/add", _params
    end
    ...
    def info(name)
      _params = {name: name}
      @master.call "templates/info", _params
    end
    ...
    def update(name, from_email = nil, from_name = nil, subject = nil, code = nil, text = nil, publish = true, labels = nil)
      _params = {name: name, from_email: from_email, from_name: from_name, subject: subject, code: code, text: text, publish: publish, labels: labels}
      @master.call "templates/update", _params
    end
    ...
    def publish(name)
      _params = {name: name}
      @master.call "templates/publish", _params
    end
    ...
    def delete(name)
      _params = {name: name}
      @master.call "templates/delete", _params
    end
    ...
    def list(label = nil)
      _params = {label: label}
      @master.call "templates/list", _params
    end
    ...
    def time_series(name)
      _params = {name: name}
      @master.call "templates/time-series", _params
    end
    ...
    def render(template_name, template_content, merge_vars = nil)
      ...
      @master.call "templates/render", _params
    end
  end
  ...
  class Exports
    ...
    def info(id)
      _params = {id: id}
      @master.call "exports/info", _params
    end
    ...
    def list
      _params = {}
      @master.call "exports/list", _params
    end
    ...
    def rejects(notify_email = nil)
      ...
      @master.call "exports/rejects", _params
    end
    ...
    def whitelist(notify_email = nil)
      _params = {notify_email: notify_email}
      @master.call "exports/whitelist", _params
    end
    ...
    def activity(notify_email = nil, date_from = nil, date_to = nil, tags = nil, senders = nil, states = nil, api_keys = nil)
      ...
      @master.call "exports/activity", _params
    end
  end
  ...
  class Users
    ...
    def info
      _params = {}
      @master.call "users/info", _params
    end
    ...
    def ping
      _params = {}
      @master.call "users/ping2", _params
    end
    ...
    def senders
      _params = {}
      @master.call "users/senders", _params
    end
  end
  ...
  class Rejects
    ...
    def add(email, comment = nil, subaccount = nil)
      ...
      @master.call "rejects/add", _params
    end
    ...
    def list(email = nil, include_expired = false, subaccount = nil)
      ...
      @master.call "rejects/list", _params
    end
    ...
    def delete(email, subaccount = nil)
      ...
      @master.call "rejects/delete", _params
    end
  end
  ...
  class Inbound
    ...
    def domains
      _params = {}
      @master.call "inbound/domains", _params
    end
    ...
    def add_domain(domain)
      ...
      @master.call "inbound/add-domain", _params
    end
    ...
    def check_domain(domain)
      _params = {domain: domain}
      @master.call "inbound/check-domain", _params
    end
    ...
    def delete_domain(domain)
      _params = {domain: domain}
      @master.call "inbound/delete-domain", _params
    end
    ...
    def routes(domain)
      _params = {domain: domain}
      @master.call "inbound/routes", _params
    end
    ...
    def add_route(domain, pattern, url)
      ...
      @master.call "inbound/add-route", _params
    end
    ...
    def update_route(id, pattern = nil, url = nil)
      ...
      @master.call "inbound/update-route", _params
    end
    ...
    def delete_route(id)
      _params = {id: id}
      @master.call "inbound/delete-route", _params
    end
    ...
    def send_raw(raw_message, to = nil, mail_from = nil, helo = nil, client_address = nil)
      ...
      @master.call "inbound/send-raw", _params
    end
  end
  ...
  class Tags
    ...
    def delete(tag)
      _params = {tag: tag}
      @master.call "tags/delete", _params
    end
    ...
    def time_series(tag)
      _params = {tag: tag}
      @master.call "tags/time-series", _params
    end
    ...
    def all_time_series
      _params = {}
      @master.call "tags/all-time-series", _params
    end
  end
  ...
  class Messages
    ...
    def send(message, async = false, ip_pool = nil, send_at = nil)
      ...
      @master.call "messages/send", _params
    end
    ...
    def send_template(template_name, template_content, message, async = false, ip_pool = nil, send_at = nil)
      ...
      @master.call "messages/send-template", _params
    end
    ...
    def search(query = "*", date_from = nil, date_to = nil, tags = nil, senders = nil, api_keys = nil, limit = 100)
      ...
      @master.call "messages/search", _params
    end
    ...
    def search_time_series(query = "*", date_from = nil, date_to = nil, tags = nil, senders = nil)
      ...
      @master.call "messages/search-time-series", _params
    end
    ...
    def info(id)
      _params = {id: id}
      @master.call "messages/info", _params
    end
    ...
    def content(id)
      _params = {id: id}
      @master.call "messages/content", _params
    end
    ...
    def parse(raw_message)
      ...
      @master.call "messages/parse", _params
    end
    ...
    def send_raw(raw_message, from_email = nil, from_name = nil, to = nil, async = false, ip_pool = nil, send_at = nil, return_path_domain = nil)
      ...
      @master.call "messages/send-raw", _params
    end
    ...
    def list_scheduled(to = nil)
      _params = {to: to}
      @master.call "messages/list-scheduled", _params
    end
    ...
    def cancel_scheduled(id)
      _params = {id: id}
      @master.call "messages/cancel-scheduled", _params
    end
    ...
    def reschedule(id, send_at)
      ...
      @master.call "messages/reschedule", _params
    end
  end
  ...
  class Whitelists
    ...
    def add(email, comment = nil)
      ...
      @master.call "whitelists/add", _params
    end
    ...
    def list(email = nil)
      _params = {email: email}
      @master.call "whitelists/list", _params
    end
    ...
    def delete(email)
      _params = {email: email}
      @master.call "whitelists/delete", _params
    end
  end
  ...
  class Ips
    ...
    def provision(warmup = false, pool = nil)
      ...
      @master.call "ips/provision", _params
    end
    ...
    def start_warmup(ip)
      _params = {ip: ip}
      @master.call "ips/start-warmup", _params
    end
    ...
    def cancel_warmup(ip)
      _params = {ip: ip}
      @master.call "ips/cancel-warmup", _params
    end
    ...
    def set_pool(ip, pool, create_pool = false)
      ...
      @master.call "ips/set-pool", _params
    end
    ...
    def delete(ip)
      _params = {ip: ip}
      @master.call "ips/delete", _params
    end
    ...
    def list_pools
      _params = {}
      @master.call "ips/list-pools", _params
    end
    ...
    def pool_info(pool)
      _params = {pool: pool}
      @master.call "ips/pool-info", _params
    end
    ...
    def create_pool(pool)
      _params = {pool: pool}
      @master.call "ips/create-pool", _params
    end
    ...
    def delete_pool(pool)
      _params = {pool: pool}
      @master.call "ips/delete-pool", _params
    end
    ...
    def check_custom_dns(ip, domain)
      ...
      @master.call "ips/check-custom-dns", _params
    end
    ...
    def set_custom_dns(ip, domain)
      _params = {ip: ip, domain: domain}
      @master.call "ips/set-custom-dns", _params
    end
  end
  ...
  class Subaccounts
    ...
    def list(q = nil)
      _params = {q: q}
      @master.call "subaccounts/list", _params
    end
    ...
    def add(id, name = nil, notes = nil, custom_quota = nil)
      ...
      @master.call "subaccounts/add", _params
    end
    ...
    def info(id)
      _params = {id: id}
      @master.call "subaccounts/info", _params
    end
    ...
    def update(id, name = nil, notes = nil, custom_quota = nil)
      _params = {id: id, name: name, notes: notes, custom_quota: custom_quota}
      @master.call "subaccounts/update", _params
    end
    ...
    def delete(id)
      _params = {id: id}
      @master.call "subaccounts/delete", _params
    end
    ...
    def pause(id)
      _params = {id: id}
      @master.call "subaccounts/pause", _params
    end
    ...
    def resume(id)
      _params = {id: id}
      @master.call "subaccounts/resume", _params
    end
  end
  ...
  class Urls
    ...
    def search(q)
      _params = {q: q}
      @master.call "urls/search", _params
    end
    ...
    def time_series(url)
      _params = {url: url}
      @master.call "urls/time-series", _params
    end
    ...
    def tracking_domains
      _params = {}
      @master.call "urls/tracking-domains", _params
    end
    ...
    def add_tracking_domain(domain)
      _params = {domain: domain}
      @master.call "urls/add-tracking-domain", _params
    end
    ...
    def check_tracking_domain(domain)
      _params = {domain: domain}
      @master.call "urls/check-tracking-domain", _params
    end
  end
  ...
  class Webhooks
    ...
    def list
      _params = {}
      @master.call "webhooks/list", _params
    end
    ...
    def add(url, description = nil, events = [])
      ...
      @master.call "webhooks/add", _params
    end
    ...
    def info(id)
      _params = {id: id}
      @master.call "webhooks/info", _params
    end
    ...
    def update(id, url, description = nil, events = [])
      ...
      @master.call "webhooks/update", _params
    end
    ...
    def delete(id)
      _params = {id: id}
      @master.call "webhooks/delete", _params
    end
  end
  ...
  class Senders
    ...
    def list
      _params = {}
      @master.call "senders/list", _params
    end
    ...
    def domains
      _params = {}
      @master.call "senders/domains", _params
    end
    ...
    def add_domain(domain)
      _params = {domain: domain}
      @master.call "senders/add-domain", _params
    end
    ...
    def check_domain(domain)
      _params = {domain: domain}
      @master.call "senders/check-domain", _params
    end
    ...
    def verify_domain(domain, mailbox)
      ...
      @master.call "senders/verify-domain", _params
    end
    ...
    def info(address)
      ...
      @master.call "senders/info", _params
    end
    ...
    def time_series(address)
      _params = {address: address}
      @master.call "senders/time-series", _params
    end
  end
  ...
  class Metadata
    ...
    def list
      _params = {}
      @master.call "metadata/list", _params
    end
    ...
    def add(name, view_template = nil)
      ...
      @master.call "metadata/add", _params
    end
    ...
    def update(name, view_template)
      _params = {name: name, view_template: view_template}
      @master.call "metadata/update", _params
    end
    ...
    def delete(name)
      _params = {name: name}
      @master.call "metadata/delete", _params
    end
  end
end
